...
import { User, Unit, Bill, MaintenanceRequest } from "../../../lib/types";
import {
  demoUsers,
  demoUnits,
  demoBills,
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <div className="flex items-center space-x-2">
              ...
              >
                ...
                <option value="with-maintenance">
                  With Pending Maintenance
                </option>
              </select>
            </div>
          </div>
          ...
          <Card key={resident.id}>
            <CardContent>
                ...
                <div className="mt-4 pt-4 border-t border-[#22304a]">
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                    ...
                    <div>
                      ...
                      <span className="ml-2 text-[#e5e7eb]">
                        {resident.unit.city}, {resident.unit.state}
                      </span>
                    </div>
                    <div>
                      <span className="text-gray-400">Type:</span>
                      <span className="ml-2 text-[#e5e7eb]">
                        {resident.unit.bedrooms}BR / {resident.unit.bathrooms}BA
                      </span>
                    </div>
                    <div>
                      <span className="text-gray-400">Rent:</span>
                      <span className="ml-2 text-[#e5e7eb]">
                        ${resident.unit.rent}/month
                      </span>
                    </div>
                  </div>
                </div>
              ...
              {(resident.bills.length > 0 ||
                resident.maintenanceRequests.length > 0) && (
                <div className="mt-4 pt-4 border-t border-[#22304a]">
